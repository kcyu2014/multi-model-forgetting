...
def identity(in_planes, out_planes, stride=1):
    if out_planes % in_planes == 0:
        ...
        raise RuntimeError("unsupported oporation")
...
# CNN_LAYER_CREATION_FUNCTIONS = [identity, avg3x3, max3x3, conv1x1, conv3x3, depthwise_3x3, depthwise_5x5]
...
CNN_LAYER_CREATION_FUNCTIONS = [identity, avg3x3, max3x3, depthwise_3x3, depthwise_5x5]


def get_cnn_layer_names():
    """
    this is the full list.
    :return:
    """
    return [layer.__name__ for layer in CNN_LAYER_CREATION_FUNCTIONS]


def get_cnn_layer_with_names():
    """a small generator """
    for i in CNN_LAYER_CREATION_FUNCTIONS:
        yield i, i.__name__
