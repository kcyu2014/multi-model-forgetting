...
from models.cnn_layers import get_cnn_layer_names
...
cata_arg.add_argument('--nb_batch_reward_controller', type=int, default=1, help='Number of batches to calculate the reward for the controller')
...
net_arg.add_argument('--shared_cnn_types', type=eval,
                     default=get_cnn_layer_names())
net_arg.add_argument('--shared_cnn_normal_types', type=eval,
                     default=get_cnn_layer_names())
net_arg.add_argument('--shared_cnn_reduce_types', type=eval,
                     default=get_cnn_layer_names())
